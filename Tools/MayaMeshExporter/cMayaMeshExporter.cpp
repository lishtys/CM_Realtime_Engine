...
//			fout << std::fixed;
			...
			fout << "VerArray =" "\n"
				...
				for (auto v : i_vertexArray)
				{
					fout << "{""\n";
					fout << "position={" <<v.vertex.x<<","<<v.vertex.y << ","<<v.vertex.z << "},"
					 "\n";
					fout << "color={" <<v.vertex.r<<","<<v.vertex.g << ","<<v.vertex.b << "," << v.vertex.a << "},"
					 "\n";
					fout << "uv={" << v.vertex.u << "," << v.vertex.v <<  "},"
					 "\n";
					fout << "normal={" << v.vertex.nx << "," << v.vertex.ny << "," << v.vertex.nz << "},"
						"\n";
					fout << "},""\n";
				}
